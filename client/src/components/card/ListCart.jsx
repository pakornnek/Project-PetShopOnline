            ...
            {user ? (
              <Link>
                <button
                  ...
                  className=" bg-red-500 w-full  rounded-md text-white py-2 shadow-md hover:bg-red-600"
                >
                  สั่งซื้อ
                </button>
              </Link>
              ...
              <Link to={"/login"}>
                <button className=" bg-blue-500 w-full  rounded-md text-white py-2 shadow-md hover:bg-red-600">
                  Login
                </button>
              </Link>
            )}
